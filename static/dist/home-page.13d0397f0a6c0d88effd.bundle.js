...
function _clearStore() {
  _clearStore = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee18(db, storeName) {
    var tx, store;
...
var Keys = _objectSpread(_objectSpread(_objectSpread({}, USER_DATA_KEYS), SERVER_USER_LISTS_KEYS), {}, {
  ...
  // map of artifact lowercase names to original names
...
var ClientCache = {
  ...
  clearUserLists: function () {
    var _clearUserLists = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee1() {
      var _this2 = this;
      var toDelete;
    ...
    function clearUserLists() {
      return _clearUserLists.apply(this, arguments);
    }
    return clearUserLists;
  }(),
  clearSeasonData: function () {
    var _clearSeasonData = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee10() {
  ...
  checkCacheTimeout: function () {
    var _checkCacheTimeout = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee11(id) {
  ...
  getFilterStr: function () {
    var _getFilterStr = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee12() {
  ...
  setFilterStr: function () {
    var _setFilterStr = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee13(filterStr) {
  ...
  getStats: function () {
    var _getStats = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee14() {
  ...
  setStats: function () {
    var _setStats = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee15(stats) {
  ...
  getFlag: function () {
    var _getFlag = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee16(flag) {
      var key;
  ...
  setFlag: function () {
    var _setFlag = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee17(flag, value) {
      var key;
    ...
    var _getArtifactLowercaseNameMap = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2() {
      ...
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.n) {
          case 0:
            _context2.n = 1;
            return _cache_manager_js__WEBPACK_IMPORTED_MODULE_0__["default"].get(_cache_manager_js__WEBPACK_IMPORTED_MODULE_0__["default"].Keys.ARTIFACTS_LOWERCASE_NAMES_MAP);
          case 1:
            artiMap = _context2.v;
            if (!(artiMap !== null)) {
              _context2.n = 2;
          ...
          case 3:
            ...
            _context2.n = 4;
            return _cache_manager_js__WEBPACK_IMPORTED_MODULE_0__["default"].cache(_cache_manager_js__WEBPACK_IMPORTED_MODULE_0__["default"].Keys.ARTIFACTS_LOWERCASE_NAMES_MAP, artiMap);
          case 4:
            return _context2.a(2, artiMap);
        }
      }, _callee2, this);
    ...
    var _getArtifactObjectList = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
      ...
      return _regenerator().w(function (_context3) {
        while (1) switch (_context3.n) {
          case 0:
            _context3.n = 1;
            return _cache_manager_js__WEBPACK_IMPORTED_MODULE_0__["default"].get(_cache_manager_js__WEBPACK_IMPORTED_MODULE_0__["default"].Keys.ARTIFACT_OBJECT_LIST);
          case 1:
          ...
          case 3:
            ...
            _context3.n = 4;
            return _cache_manager_js__WEBPACK_IMPORTED_MODULE_0__["default"].cache(_cache_manager_js__WEBPACK_IMPORTED_MODULE_0__["default"].Keys.ARTIFACT_OBJECT_LIST, objectList);
          case 4:
            return _context3.a(2, objectList);
        }
      }, _callee3, this);
...
/***/ "./static/assets/js/e7/filter-parsing/declared-data-types.ts":
/*!*******************************************************************!*\
  !*** ./static/assets/js/e7/filter-parsing/declared-data-types.ts ***!
  \*******************************************************************/
...
/* harmony export */ });
/* harmony import */ var _filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./filter-utils.ts */ "./static/assets/js/e7/filter-parsing/filter-utils.ts");
/* harmony import */ var _regex_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../regex.js */ "./static/assets/js/e7/regex.js");
/* harmony import */ var _utils_ts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../utils.ts */ "./static/assets/js/utils.ts");
...
/* harmony import */ var _filter_parse_references_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./filter-parse-references.ts */ "./static/assets/js/e7/filter-parsing/filter-parse-references.ts");
/* harmony import */ var _references_ts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../references.ts */ "./static/assets/js/e7/references.ts");
...
class StringType extends DataType {
    constructor(str, REFS, kwargs) {
        super(str);
        this.data = this.getData(str, REFS, kwargs || { types: STRING_TYPES });
    }
    getData(str, REFS, kwargs = { types: STRING_TYPES }) {
        str = _filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].trimSurroundingQuotes(str);
        str = str.trim();
        ...
        if (!_regex_js__WEBPACK_IMPORTED_MODULE_1__.RegExps.VALID_STRING_RE.test(str)) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].SyntaxException(`Invalid string; all string content must start with a letter followed by either num, hyphen or period ( case insensitive regex: ${_regex_js__WEBPACK_IMPORTED_MODULE_1__.RegExps.VALID_STRING_LITERAL_RE.source} ); got: [${str}]`);
        }
        function parseFn(type, str) {
            switch (type) {
                case "hero":
                    return _hero_manager_js__WEBPACK_IMPORTED_MODULE_3__["default"].getHeroByName(str, REFS.HM)?.name;
                case "league":
                    return _references_ts__WEBPACK_IMPORTED_MODULE_5__.LEAGUE_MAP[str] ? (0,_utils_ts__WEBPACK_IMPORTED_MODULE_2__.toTitleCase)(str) : null;
                case "server":
                    return Object.values(_references_ts__WEBPACK_IMPORTED_MODULE_5__.WORLD_CODE_TO_CLEAN_STR).find((server) => server.toLowerCase() === str);
                case "equipment":
                    return _filter_parse_references_ts__WEBPACK_IMPORTED_MODULE_4__.EQUIPMENT_LOWERCASE_STRINGS_MAP[str];
                case "artifact":
        ...
        throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].SyntaxException(`Invalid string; All strings must either be a valid [${kwargs.types.join(", ")}]; got: [${str}]`);
    }
    asString() {
        return `"${this.data}"`;
    }
...
class DateType extends DataType {
    constructor(str) {
        super(str);
        this.data = this.getData(str);
    }
    getData(str) {
        return _filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].parseDate(str);
    }
    asString() {
...
class IntType extends DataType {
    ...
    getData(str) {
        if (!_regex_js__WEBPACK_IMPORTED_MODULE_1__.RegExps.VALID_INT_LITERAL_RE.test(str)) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].SyntaxException(`Invalid integer; must be a number; got: '${str}'`);
        }
...
class BoolType extends DataType {
    ...
    getData(str) {
        if (!_regex_js__WEBPACK_IMPORTED_MODULE_1__.RegExps.VALID_BOOL_LITERAL_RE.test(str)) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].SyntaxException(`Invalid boolean; must be 'true' or 'false'; got: '${str}'`);
        }
        return str === "true" ? 1 : 0;
    }
    asString() {
...
class RangeType extends DataType {
    ...
    getData(str) {
        let split = str.split("...");
        if (split.length !== 2) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].SyntaxException(`Invalid range; ranges must be of the format x...y or x...=y ; got more than two values when splitting string: '${str}'`);
        }
        let [start, end] = split;
        ...
        if (_regex_js__WEBPACK_IMPORTED_MODULE_1__.RegExps.VALID_DATE_LITERAL_RE.test(start)) {
            output.start = _filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].tryConvert(_filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].parseDate, "Date", start, `Could not convert '${start}' to Date in declared range: '${str}'`);
            output.end = _filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].tryConvert(_filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].parseDate, "Date", end, `Could not convert '${end}' to Date in declared range: '${str}' ; Ranges must have homogenous types`);
            if (output.start && output.end && output.start > output.end) {
                throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].SyntaxException(`Invalid range; start date must be on or before end date; ${output.start} > ${output.end}`);
            }
            output.type = "Date";
        }
        else if (_regex_js__WEBPACK_IMPORTED_MODULE_1__.RegExps.VALID_INT_LITERAL_RE.test(start)) {
            output.start = _filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].tryConvert((i) => new IntType(i), "Int", start, `Could not convert '${start}' to Int in declared range: '${str}'`).data;
            output.end = _filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].tryConvert((i) => new IntType(i), "Int", end, `Could not convert '${end}' to Int in declared range: '${str}' ; Ranges must have homogenous types`).data;
            if (output.start && output.end && output.start > output.end) {
                throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].SyntaxException(`Invalid range; start integer must be equal to or less than end integer; ${output.start} > ${output.end}`);
            }
            output.type = "Int";
        }
        else {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].SyntaxException(`Invalid range; must be of the format x...y or x...=y ; got: '${str}'`);
        }
...
class SetType extends DataType {
    ...
    getType(elements) {
        ...
        if (types.length > 1) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].SyntaxException(`Invalid set; all set elements must have the same data type; 
    ...
    getData(str, REFS, kwargs = { types: STRING_TYPES }) {
        if (!_regex_js__WEBPACK_IMPORTED_MODULE_1__.RegExps.VALID_SET_RE.test(str)) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].SyntaxException(`Invalid set; must be in the format: { element1, element2,... }, where elements have either string format or date format; ( case insensitive regex: ${_regex_js__WEBPACK_IMPORTED_MODULE_1__.RegExps.VALID_SET_RE.source} ) (Just chat gpt this one bro); got: '${str}'`);
        }
        const elements = _filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].tokenizeWithNestedEnclosures(str, ",", 1, true)
            .map((elt) => {
            if (_regex_js__WEBPACK_IMPORTED_MODULE_1__.RegExps.VALID_SEASON_LITERAL_RE.test(elt)) {
            ...
            else if (_regex_js__WEBPACK_IMPORTED_MODULE_1__.RegExps.VALID_STRING_RE.test(elt)) {
                return new StringType(elt, REFS, kwargs);
            }
            else {
                throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].SyntaxException(`Invalid set element; must be a string or date; got: '${elt}'`);
            }
        });
        console.log("GOT ELEMENTS: ", elements);
        this.type = this.getType(elements);
        this.str = `{${elements.map((data) => data.asString()).join(", ")}}`;
        const list = elements.map((data) => data.data);
        this.list = list;
        return new Set(list);
    }
    asString() {
...
function parseKeywordAsDataType(str, REFS) {
    if (_regex_js__WEBPACK_IMPORTED_MODULE_1__.RegExps.VALID_SEASON_LITERAL_RE.test(str)) {
        ...
        if (REFS.SeasonDetails.length < 1) {
            ...
            const seasonCode = REFS.SeasonDetails.find((season) => season["Status"] === "Active").Code;
...
function parseDataType(str, REFS) {
    ...
    if (_regex_js__WEBPACK_IMPORTED_MODULE_1__.RegExps.VALID_STRING_LITERAL_RE.test(str)) {
        ...
        return new StringType(str, REFS, { types: STRING_TYPES });
    }
        ...
        if (_regex_js__WEBPACK_IMPORTED_MODULE_1__.RegExps.VALID_STRING_LITERAL_RE.test(`'${str}'`)) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].SyntaxException(`Invalid DataType declaration; got: '${str}'; did you forget to wrap string literals in double or single quotes?`);
        }
        else if (str.includes("'") && str.includes('"')) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].SyntaxException(`Invalid DataType declaration; got: '${str}'; did you encase in mismatching quote types?`);
        }
        else if (str.includes(".=") || str.includes("..")) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].SyntaxException(`Invalid DataType declaration; got: '${str}'; were you trying to use a range? Ranges must be of the format x...y or x...=y and may only be int-int or date-date`);
        }
        throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].SyntaxException(`Invalid DataType declaration; could not parse to valid Field or Declared Data Type; got: '${str}'`);
    }
}
const TYPES = {
    Date: DateType,
...
/***/ "./static/assets/js/e7/filter-parsing/field-type.ts":
/*!**********************************************************!*\
  !*** ./static/assets/js/e7/filter-parsing/field-type.ts ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
class FieldType {
    ...
    static FIELD_EXTRACT_FN_MAP = {
        date: (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.DATE_TIME]
            ? new Date(`${battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.DATE_TIME].slice(0, 10)}T00:00:00`)
            : "N/A",
        season: (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.SEASON_CODE],
        "is-first-pick": (battle) => (battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.FIRST_PICK] ? 1 : 0),
        "is-win": (battle) => (battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.WIN] ? 1 : 0),
        "victory-points": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P1_POINTS],
        "p1.picks": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P1_PICKS],
        "p2.picks": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P2_PICKS],
        "p1.prebans": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P1_PREBANS],
        "p2.prebans": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P2_PREBANS],
        "p1.postban": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P1_POSTBAN],
        "p2.postban": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P2_POSTBAN],
        prebans: (battle) => [
            ...battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P1_PREBANS],
            ...battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P2_PREBANS],
        ],
        "p1.pick1": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P1_PICKS][0],
        "p1.pick2": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P1_PICKS][1],
        "p1.pick3": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P1_PICKS][2],
        "p1.pick4": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P1_PICKS][3],
        "p1.pick5": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P1_PICKS][4],
        "p2.pick1": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P2_PICKS][0],
        "p2.pick2": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P2_PICKS][1],
        "p2.pick3": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P2_PICKS][2],
        "p2.pick4": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P2_PICKS][3],
        "p2.pick5": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P2_PICKS][4],
        "p1.league": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P1_LEAGUE],
        "p2.league": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P2_LEAGUE],
        "p1.server": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P1_SERVER],
        "p2.server": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P2_SERVER],
        "p1.id": (battle) => Number(battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P1_ID]),
        "p2.id": (battle) => Number(battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P2_ID]),
        "p1.mvp": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P1_MVP],
        "p2.mvp": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P2_MVP],
        "is-first-turn": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.FIRST_TURN],
        "first-turn-hero": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.FIRST_TURN_HERO],
        turns: (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.TURNS],
        seconds: (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.SECONDS],
        "point-gain": (battle) => battle[_references_ts__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.POINT_GAIN],
    };
    constructor(str) {
        const fn = FieldType.FIELD_EXTRACT_FN_MAP[str];
        if (!fn) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_0__["default"].ValidationError(`Invalid field type: '${str}'; valid types are: ${Object.keys(FieldType.FIELD_EXTRACT_FN_MAP).join(", ")}`);
        }
        else {
...
/***/ "./static/assets/js/e7/filter-parsing/filter-syntax-parser.ts":
/*!********************************************************************!*\
  !*** ./static/assets/js/e7/filter-parsing/filter-syntax-parser.ts ***!
  \********************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _hero_manager_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../hero-manager.js */ "./static/assets/js/e7/hero-manager.js");
/* harmony import */ var _filter_utils_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./filter-utils.ts */ "./static/assets/js/e7/filter-parsing/filter-utils.ts");
...
/* harmony import */ var _filter_parse_references_ts__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./filter-parse-references.ts */ "./static/assets/js/e7/filter-parsing/filter-parse-references.ts");
/* harmony import */ var _field_type_ts__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./field-type.ts */ "./static/assets/js/e7/filter-parsing/field-type.ts");
/* harmony import */ var _declared_data_types_ts__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./declared-data-types.ts */ "./static/assets/js/e7/filter-parsing/declared-data-types.ts");
/* harmony import */ var _functions_ts__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./functions.ts */ "./static/assets/js/e7/filter-parsing/functions.ts");
/* harmony import */ var _operators_ts__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./operators.ts */ "./static/assets/js/e7/filter-parsing/operators.ts");
...
function validateChars(str, charSet, objName) {
    for (let char of str) {
        if (!charSet.has(char)) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_1__["default"].SyntaxException(`Invalid character within <${objName}> ; ' ${char} ' is not allowed; got string: '${str}'`);
        }
    }
}
function preParse(str) {
    str = str.replace(/[\n\t\r]/g, " ").replace(/\s+/g, " "); // replace newlines with spaces and remove multiple spaces
    validateChars(str, _filter_parse_references_ts__WEBPACK_IMPORTED_MODULE_6__.ACCEPTED_CHARS, "Main Filter String");
    str = str.toLowerCase();
    return str;
}
class BaseFilter {
...
function tryParseFilterElement(leftOrRight, strValue, filterStr, REFS) {
    ...
    try {
        if (strValue in _field_type_ts__WEBPACK_IMPORTED_MODULE_7__.FieldType.FIELD_EXTRACT_FN_MAP) {
            parsedValue = new _field_type_ts__WEBPACK_IMPORTED_MODULE_7__.FieldType(strValue);
        }
        else {
            parsedValue = (0,_declared_data_types_ts__WEBPACK_IMPORTED_MODULE_8__.parseDataType)(strValue, REFS);
        }
    }
    catch (e) {
        console.error(e);
        throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_1__["default"].SyntaxException(`Could not parse ${leftOrRight} side of filter; got: "${strValue}" from filter: [${filterStr}]; error: ${e.message}`);
    }
    return parsedValue;
}
function validateBaseFilter(left, opStr, right, str) {
    ...
    if (opStr === "in" || opStr === "!in") {
        if (!(right instanceof _declared_data_types_ts__WEBPACK_IMPORTED_MODULE_8__.TYPES.Set || right instanceof _declared_data_types_ts__WEBPACK_IMPORTED_MODULE_8__.TYPES.Range)) {
            if (!(right instanceof _field_type_ts__WEBPACK_IMPORTED_MODULE_7__.FieldType) || !_field_type_ts__WEBPACK_IMPORTED_MODULE_7__.SET_FIELDS.has(right.str)) {
                throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_1__["default"].TypeException(`When using any 'in' or '!in' operator, the right side of the operator must be a Set, Range, or a Field composed of a set (i.e. p1.picks, p2.prebans, etc.); error found in filter: '${str}'`);
            }
        }
    }
    if (right instanceof _declared_data_types_ts__WEBPACK_IMPORTED_MODULE_8__.TYPES.Range) {
        if (right.data.type === "Date") {
            if (!left.str?.includes("date")) {
                throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_1__["default"].TypeException(`When using a Date Range, the left side of the operator must be a date field; ${left.str} is not a date field; error found in filter: '${str}'`);
            }
        }
        else if (right.data.type === "Int") {
            if (!_field_type_ts__WEBPACK_IMPORTED_MODULE_7__.INT_FIELDS.has(left.str ?? "")) {
                throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_1__["default"].TypeException(`When using an Int Range, the left side of the operator must be an integer field; ${left.str} is not an integer field; error found in filter: '${str}'`);
            }
        }
    }
    if (right instanceof _declared_data_types_ts__WEBPACK_IMPORTED_MODULE_8__.DataType && left instanceof _declared_data_types_ts__WEBPACK_IMPORTED_MODULE_8__.DataType) {
        throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_1__["default"].SyntaxException(`Either left or right side of filter must be a data field (a property of a battle); both ${left} and ${right} are user declared data types in filter: "${str}"`);
    }
}
class FilterSyntaxParser {
    ...
    static async getFiltersFromCache(HM) {
        const filterStr = await _cache_manager_js__WEBPACK_IMPORTED_MODULE_5__["default"].getFilterStr();
        if (!filterStr) {
            return FilterSyntaxParser.getEmptyFilters();
        }
        const seasonDetails = await _season_manager_js__WEBPACK_IMPORTED_MODULE_3__["default"].getSeasonDetails();
    ...
    async addReferences(HM = null, SeasonDetails = null) {
        HM = HM || (await _hero_manager_js__WEBPACK_IMPORTED_MODULE_0__["default"].getHeroManager());
        if (HM === null)
            throw new Error("Hero Manager could not be retrieved to parse filters.");
        SeasonDetails = SeasonDetails || (await _season_manager_js__WEBPACK_IMPORTED_MODULE_3__["default"].getSeasonDetails());
        if (SeasonDetails === null)
            throw new Error("Season Details could not be retrieved to parse filters.");
        const ARTIFACT_LOWERCASE_STRINGS_MAP = await _artifact_manager_js__WEBPACK_IMPORTED_MODULE_4__["default"].getArtifactLowercaseNameMap();
        this.REFS = {
            HM: HM,
    ...
    asString() {
        ...
        return `[\n${filters
            .map((filter) => filter.asString(_filter_parse_references_ts__WEBPACK_IMPORTED_MODULE_6__.PRINT_PREFIX))
            .join(";\n")}\n]`;
    }
    parseGlobalFilterFn(globalFilterFnClass, str) {
        const pattern = _regex_js__WEBPACK_IMPORTED_MODULE_2__.RegExps.anchorExp(_regex_js__WEBPACK_IMPORTED_MODULE_2__.RegExps.VALID_GLOBAL_FILTER_RE);
        if (!pattern.test(str)) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_1__["default"].SyntaxException(`Invalid global filter format; must follow the case insensitive regex format "${pattern.source}" ; got: '${str}'`);
        }
        const [delim, enclosureLevel] = [",", 1];
        const args = _filter_utils_ts__WEBPACK_IMPORTED_MODULE_1__["default"].tokenizeWithNestedEnclosures(str, delim, enclosureLevel);
        return { localFilters: [], globalFilters: [new globalFilterFnClass(args)] };
    }
    parseClauseFn(clauseFnClass, str) {
        console.log("Parsing clause fn:", str);
        const [delim, enclosureLevel] = [",", 1];
        const argArr = _filter_utils_ts__WEBPACK_IMPORTED_MODULE_1__["default"].tokenizeWithNestedEnclosures(str, delim, enclosureLevel).filter((s) => s.length > 0); // account for trailing commas
        console.log("Got argArr:", argArr);
        if (clauseFnClass instanceof _functions_ts__WEBPACK_IMPORTED_MODULE_9__.XOR && argArr.length < 2) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_1__["default"].SyntaxException(`XOR clause must have at least two arguments; got: ${argArr.length} arguments from string: "${str}"`);
        }
        else if (clauseFnClass instanceof _functions_ts__WEBPACK_IMPORTED_MODULE_9__.NOT && argArr.length !== 1) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_1__["default"].SyntaxException(`NOT clause must have exactly one argument; got: ${argArr.length} arguments from string: "${str}"`);
        }
        ...
        if (fns.globalFilters.length > 0) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_1__["default"].SyntaxException(`Global filters not allowed in clause functions; got: ${fns.globalFilters} from string: "${str}"`);
        }
        if (clauseFnClass instanceof _functions_ts__WEBPACK_IMPORTED_MODULE_9__.NOT && fns.localFilters.length !== 1) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_1__["default"].SyntaxException(`NOT clause must have exactly one argument; got: ${fns.localFilters.length} arguments from string: "${str}"`);
        }
    ...
    parseBaseFilter(str) {
        ...
        const tokens = _filter_utils_ts__WEBPACK_IMPORTED_MODULE_1__["default"].tokenizeWithNestedEnclosures(str, delim, enclosureLevel, trim);
        console.log("Got tokens: ", tokens, `; Length: ${tokens.length}`);
        // must be of form ['X', operator, 'Y']
        if (!(tokens.length === 3)) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_1__["default"].SyntaxException(`Invalid base filter format; all filters must be of the form: ['X', operator, 'Y']; got tokens: [${tokens.join(", ")}]`);
        }
        let [left, opStr, right] = tokens;
        // Validate operator
        if (!_operators_ts__WEBPACK_IMPORTED_MODULE_10__.OPERATOR_MAP[opStr]) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_1__["default"].SyntaxException(`Invalid operator in base filter; got: "${opStr}" as the operator in filter: [${str}]`);
        }
        const opFn = _operators_ts__WEBPACK_IMPORTED_MODULE_10__.OPERATOR_MAP[opStr];
        // try to converty to field types and data types
        const leftParsed = tryParseFilterElement("left", left, str, this.REFS);
        const rightParsed = tryParseFilterElement("right", right, str, this.REFS);
        // validate filter
        validateBaseFilter(leftParsed, opStr, rightParsed, str);
        // make filter
        let filterFn = null;
        if (leftParsed instanceof _declared_data_types_ts__WEBPACK_IMPORTED_MODULE_8__.DataType && rightParsed instanceof _field_type_ts__WEBPACK_IMPORTED_MODULE_7__.FieldType) {
            filterFn = (battle) => {
                return opFn(leftParsed.data, rightParsed.extractData(battle));
            };
        }
        else if (leftParsed instanceof _field_type_ts__WEBPACK_IMPORTED_MODULE_7__.FieldType && rightParsed instanceof _declared_data_types_ts__WEBPACK_IMPORTED_MODULE_8__.DataType) {
            filterFn = (battle) => {
                return opFn(leftParsed.extractData(battle), rightParsed.data);
            };
        }
        else if (leftParsed instanceof _field_type_ts__WEBPACK_IMPORTED_MODULE_7__.FieldType && rightParsed instanceof _field_type_ts__WEBPACK_IMPORTED_MODULE_7__.FieldType) {
            filterFn = (battle) => {
    ...
    parseFilters(str) {
        ...
        for (let splitStr of split) {
            let charCounts = _filter_utils_ts__WEBPACK_IMPORTED_MODULE_1__["default"].getCharCounts(splitStr);
            if (charCounts["("] !== charCounts[")"]) {
                throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_1__["default"].SyntaxException(`Imbalanced parentheses in following string: "${splitStr}"`);
            }
            else if (charCounts["{"] !== charCounts["}"]) {
                throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_1__["default"].SyntaxException(`Imbalanced braces ('{', '}') in following string: "${splitStr}"`);
            }
        }
        if (split.length > 1) {
        ...
        if (filterString.length < 4) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_1__["default"].SyntaxException(`Filter string cannot be valid (less than 4 characters); got filter string: [${filterString}]`);
        }
        ...
        if (_functions_ts__WEBPACK_IMPORTED_MODULE_9__.FN_MAP.CLAUSE_FNS[fnStr]) {
            console.log("Found clause fn; dispatching to clause fn parser");
            return this.parseClauseFn(_functions_ts__WEBPACK_IMPORTED_MODULE_9__.FN_MAP.CLAUSE_FNS[fnStr], filterString);
        }
        else if (_functions_ts__WEBPACK_IMPORTED_MODULE_9__.FN_MAP.GLOBAL_FNS[fnStr]) {
            console.log("Found global filter fn; dispatching to global filter fn parser");
            return this.parseGlobalFilterFn(_functions_ts__WEBPACK_IMPORTED_MODULE_9__.FN_MAP.GLOBAL_FNS[fnStr], filterString);
        }
        else if (_functions_ts__WEBPACK_IMPORTED_MODULE_9__.FN_MAP.DIRECT_FNS[fnStr]) {
            return this.parseDirectFn(_functions_ts__WEBPACK_IMPORTED_MODULE_9__.FN_MAP.DIRECT_FNS[fnStr], filterString);
        }
        else {
...
function parseDate(dateStr) {
    if (!_regex_js__WEBPACK_IMPORTED_MODULE_0__.RegExps.VALID_DATE_LITERAL_RE.test(dateStr)) {
        throw new SyntaxException(`Invalid date; must be in the format: YYYY-MM-DD ( regex: ${_regex_js__WEBPACK_IMPORTED_MODULE_0__.RegExps.VALID_DATE_LITERAL_RE.source} ); got: '${dateStr}'`);
    }
...
/* harmony export */   ClauseFn: () => (/* binding */ ClauseFn),
/* harmony export */   CombatReadinessGeqFn: () => (/* binding */ CombatReadinessGeqFn),
/* harmony export */   DirectFn: () => (/* binding */ DirectFn),
/* harmony export */   EquipmentFn: () => (/* binding */ EquipmentFn),
/* harmony export */   FN_MAP: () => (/* binding */ FN_MAP),
/* harmony export */   GlobalFilterFn: () => (/* binding */ GlobalFilterFn),
/* harmony export */   NOT: () => (/* binding */ NOT),
/* harmony export */   OR: () => (/* binding */ OR),
/* harmony export */   XOR: () => (/* binding */ XOR),
/* harmony export */   lastN: () => (/* binding */ lastN)
/* harmony export */ });
/* harmony import */ var _declared_data_types_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./declared-data-types.ts */ "./static/assets/js/e7/filter-parsing/declared-data-types.ts");
/* harmony import */ var _filter_parse_references_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./filter-parse-references.ts */ "./static/assets/js/e7/filter-parsing/filter-parse-references.ts");
/* harmony import */ var _filter_utils_ts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./filter-utils.ts */ "./static/assets/js/e7/filter-parsing/filter-utils.ts");
...
/* harmony import */ var _utils_ts__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ../../utils.ts */ "./static/assets/js/utils.ts");
...
class Fn {
    constructor() { }
    call(_battle) {
        console.error(`Base class ${this.constructor.name} does not implement the 'call' method. Implement this method in a subclass.`);
        return false;
    }
}
...
class lastN extends GlobalFilterFn {
    ...
    constructor(args) {
        ...
        this.name = "last-N";
        if (args.length !== 1) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_2__["default"].SyntaxException(`${this.name} expects 1 argument, got ${args.length}`);
        }
        const num = Number(args[0]);
        if (!Number.isInteger(num)) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_2__["default"].TypeException(`${this.name} expects an integer argument, could not parse '${args[0]}' as integer`);
        }
        this.str = `${this.name}(${num})`;
        this.n = num;
    }
    call(battles) {
        battles.sort((b1, b2) => b1[_references_ts__WEBPACK_IMPORTED_MODULE_4__.COLUMNS_MAP.DATE_TIME].localeCompare(b2[_references_ts__WEBPACK_IMPORTED_MODULE_4__.COLUMNS_MAP.DATE_TIME]));
...
class ClauseFn extends Fn {
    ...
    asString(prefix = "") {
        let output = "";
        const newPrefix = prefix + _filter_parse_references_ts__WEBPACK_IMPORTED_MODULE_1__.PRINT_PREFIX;
        this.filterContainer.localFilters.forEach((fn) => (output += `${fn.asString(newPrefix)},\n`));
...
class EquipmentFn extends DirectFn {
    ...
    static fromFilterStr(str, REFS) {
        const args = _filter_utils_ts__WEBPACK_IMPORTED_MODULE_2__["default"].tokenizeWithNestedEnclosures(str, ",", 1, true);
        if (!(args.length === 2)) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_2__["default"].SyntaxException(`Invalid equipment function call ; accepts exactly 2 arguments ; got: [${args}] from str: ${str}`);
        }
        if (!_regex_js__WEBPACK_IMPORTED_MODULE_3__.RegExps.VALID_STRING_LITERAL_RE.test(args[0])) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_2__["default"].TypeException(`Invalid equipment function call ; first argument must be a valid string literal ; got: '${args[0]}' from str: ${str}`);
        }
        const equipSetStr = /^\{[",'a-z\s]*\}$/i.test(args[1])
            ? args[1]
            : `{${args[1]}}`;
        let hero, equipmentSet;
        try {
            [hero, equipmentSet] = [
                new _declared_data_types_ts__WEBPACK_IMPORTED_MODULE_0__.TYPES.String(args[0], REFS, { types: ["hero"] }),
                new _declared_data_types_ts__WEBPACK_IMPORTED_MODULE_0__.TYPES.Set(equipSetStr, REFS, { types: ["equipment"] }),
            ];
        }
        catch (e) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_2__["default"].TypeException(`Invalid type in equipment function call; got str: ${str} ; error: ${e}`);
        }
    ...
    constructor(hero, equipmentSet, p1Flag) {
        ...
        super();
        this.hero = hero.data;
        this.equipmentCounts = (0,_utils_ts__WEBPACK_IMPORTED_MODULE_5__.arrToCountMap)(equipmentSet.list);
        this.str =
            (p1Flag ? "p1" : "p2") +
    ...
    call(battle) {
        ...
        const equippedCounts = (0,_utils_ts__WEBPACK_IMPORTED_MODULE_5__.arrToCountMap)(equipped);
...
class ArtifactFn extends DirectFn {
    ...
    static fromFilterStr(str, REFS) {
        const args = _filter_utils_ts__WEBPACK_IMPORTED_MODULE_2__["default"].tokenizeWithNestedEnclosures(str, ",", 1, true);
        if (!(args.length === 2)) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_2__["default"].SyntaxException(`Invalid artifact function call ; accepts exactly 2 arguments ; got: [${args}] from str: ${str}`);
        }
        if (!_regex_js__WEBPACK_IMPORTED_MODULE_3__.RegExps.anchorExp(_regex_js__WEBPACK_IMPORTED_MODULE_3__.RegExps.VALID_STRING_LITERAL_RE).test(args[0])) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_2__["default"].TypeException(`Invalid artifact function call ; first argument must be a valid string literal ; got: '${args[0]}' from str: ${str}`);
        }
        const artifactSetStr = _regex_js__WEBPACK_IMPORTED_MODULE_3__.RegExps.VALID_SET_RE.test(args[1])
            ? args[1]
            : `{${args[1]}}`;
        let hero, artifactSet;
        try {
            [hero, artifactSet] = [
                new _declared_data_types_ts__WEBPACK_IMPORTED_MODULE_0__.TYPES.String(args[0], REFS, { types: ["hero"] }),
                new _declared_data_types_ts__WEBPACK_IMPORTED_MODULE_0__.TYPES.Set(artifactSetStr, REFS, { types: ["artifact"] }),
            ];
        }
        catch (e) {
            console.error(e);
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_2__["default"].TypeException(`Invalid type in artifact function call; got str: ${str} ; error: ${e}`);
        }
        const p1Flag = str.split(".")[0] === "p1";
    ...
    call(battle) {
        ...
        console.log(`Got equipped Artifact: ${equippedArtifact}, hero: ${this.hero}, picks: ${JSON.stringify(picks)}, artifacts: ${JSON.stringify(artifacts)}`);
        if (!equippedArtifact) {
            return false;
        }
...
class CombatReadinessGeqFn extends DirectFn {
    ...
    static fromFilterStr(str, REFS) {
        ...
        if (!_regex_js__WEBPACK_IMPORTED_MODULE_3__.RegExps.VALID_STRING_LITERAL_RE.test(args[0])) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_2__["default"].TypeException(`Invalid CR-GEQ function call ; first argument must be a valid string literal ; got: '${args[0]}' from str: ${str}`);
        }
        else if (!_regex_js__WEBPACK_IMPORTED_MODULE_3__.RegExps.VALID_INT_LITERAL_RE.test(args[1])) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_2__["default"].TypeException(`Invalid CR-GEQ function call ; second argument must be a valid integer literal ; got: '${args[1]}' from str: ${str}`);
        }
        const crThresholdStr = args[1];
        let hero, crThreshold;
        try {
            [hero, crThreshold] = [
                new _declared_data_types_ts__WEBPACK_IMPORTED_MODULE_0__.TYPES.String(args[0], REFS, { types: ["hero"] }),
                new _declared_data_types_ts__WEBPACK_IMPORTED_MODULE_0__.TYPES.Int(crThresholdStr),
            ];
        }
        catch (e) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_2__["default"].TypeException(`Invalid type in CR-GEQ function call; got str: ${str} ; error: ${e}`);
        }
        const p1Flag = str.split(".")[0] === "p1";
    ...
    call(battle) {
        const findFn = (entry, picks) => picks.includes(entry[0]) &&
            entry[1] >= this.crThreshold &&
            entry[0] === this.hero;
        const result = this.isPlayer1
            ? battle[_references_ts__WEBPACK_IMPORTED_MODULE_4__.COLUMNS_MAP.CR_BAR].find((entry) => findFn(entry, battle[_references_ts__WEBPACK_IMPORTED_MODULE_4__.COLUMNS_MAP.P1_PICKS]))
            : battle[_references_ts__WEBPACK_IMPORTED_MODULE_4__.COLUMNS_MAP.CR_BAR].find((entry) => findFn(entry, battle[_references_ts__WEBPACK_IMPORTED_MODULE_4__.COLUMNS_MAP.P2_PICKS]));
        console.log(`Got CR Result: ${result}, hero: ${this.hero}, minValue: ${this.crThreshold}`);
...
class CombatReadinessLtFn extends DirectFn {
    ...
    static fromFilterStr(str, REFS) {
        ...
        if (!_regex_js__WEBPACK_IMPORTED_MODULE_3__.RegExps.VALID_STRING_LITERAL_RE.test(args[0])) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_2__["default"].TypeException(`Invalid CR-LT function call ; first argument must be a valid string literal ; got: '${args[0]}' from str: ${str}`);
        }
        else if (!_regex_js__WEBPACK_IMPORTED_MODULE_3__.RegExps.VALID_INT_LITERAL_RE.test(args[1])) {
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_2__["default"].TypeException(`Invalid CR-LT function call ; second argument must be a valid integer literal ; got: '${args[1]}' from str: ${str}`);
        }
        const crThresholdStr = args[1];
        let hero, crThreshold;
        try {
            ...
            throw new _filter_utils_ts__WEBPACK_IMPORTED_MODULE_2__["default"].TypeException(`Invalid type in CR-LT function call; got str: ${str} ; error: ${e}`);
        }
        const p1Flag = str.split(".")[0] === "p1";
        console.log(`Sending CR fn args`, hero, crThreshold, p1Flag);
...
function addDicts(HM) {
  ...
  for (var i = 0; i < numKeys - 1; i++) {
    var prime = _references_ts__WEBPACK_IMPORTED_MODULE_2__.PRIMES[i];
    for (var j = i + 1; j < numKeys; j++) {
      var prime2 = _references_ts__WEBPACK_IMPORTED_MODULE_2__.PRIMES[j];
  ...
  createHeroManager: function createHeroManager(rawHeroList) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        var prime = _references_ts__WEBPACK_IMPORTED_MODULE_2__.PRIMES[index];
...
/* harmony export */ });
/* harmony import */ var _filter_parsing_field_type_ts__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./filter-parsing/field-type.ts */ "./static/assets/js/e7/filter-parsing/field-type.ts");
...
var VALID_FIELD_WORDS = Object.keys(_filter_parsing_field_type_ts__WEBPACK_IMPORTED_MODULE_0__.FieldType.FIELD_EXTRACT_FN_MAP);
...
var EMPTY_SET_RE = /\{\s*\}/;
var VALID_INT_RE = /-?\d+/;
var VALID_SEASON_RE = /season-[1-9]+[0-9]*f?|current-season/i;
...
function getServerStats(battlesList) {
  ...
  for (var _i3 = 0, _Object$values2 = Object.values(_references_ts__WEBPACK_IMPORTED_MODULE_1__.WORLD_CODE_TO_CLEAN_STR); _i3 < _Object$values2.length; _i3++) {
    _loop4();
  }
...
var userMapCacheKeyMap = _defineProperty(_defineProperty(_defineProperty(_defineProperty(_defineProperty({}, _references_ts__WEBPACK_IMPORTED_MODULE_0__.WORLD_CODE_ENUM.GLOBAL, _cache_manager_js__WEBPACK_IMPORTED_MODULE_1__["default"].Keys.GLOBAL_USERS), _references_ts__WEBPACK_IMPORTED_MODULE_0__.WORLD_CODE_ENUM.EU, _cache_manager_js__WEBPACK_IMPORTED_MODULE_1__["default"].Keys.EU_USERS), _references_ts__WEBPACK_IMPORTED_MODULE_0__.WORLD_CODE_ENUM.ASIA, _cache_manager_js__WEBPACK_IMPORTED_MODULE_1__["default"].Keys.ASIA_USERS), _references_ts__WEBPACK_IMPORTED_MODULE_0__.WORLD_CODE_ENUM.JPN, _cache_manager_js__WEBPACK_IMPORTED_MODULE_1__["default"].Keys.JPN_USERS), _references_ts__WEBPACK_IMPORTED_MODULE_0__.WORLD_CODE_ENUM.KOR, _cache_manager_js__WEBPACK_IMPORTED_MODULE_1__["default"].Keys.KOR_USERS);
function createUser(userJSON, world_code) {
  return {
    id: userJSON.nick_no,
...
function _getUserMapFromE7Server() {
  _getUserMapFromE7Server = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee6(world_code) {
    var rawUserJSON;
    return _regenerator().w(function (_context6) {
      while (1) switch (_context6.n) {
        case 0:
        ...
        case 2:
          ...
          return _context6.a(2, Object.fromEntries(rawUserJSON.users.map(function (user) {
...
function _getUserMap() {
  _getUserMap = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee7(world_code) {
...
var cleanStr = function cleanStr(world_code) {
  return _references_ts__WEBPACK_IMPORTED_MODULE_0__.WORLD_CODE_TO_CLEAN_STR[world_code];
};
...
var UserManager = {
   ...
   */
  findUser: function () {
    var _findUser = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee(searchUser) {
      var identifier, result, user;
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            console.log("Attempting to find user: ".concat(JSON.stringify(searchUser)));
  ...
  setUser: function () {
    var _setUser = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(userData) {
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.n) {
          case 0:
            _context2.n = 1;
  ...
  getUser: function () {
    var _getUser = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee3() {
      return _regenerator().w(function (_context3) {
        while (1) switch (_context3.n) {
          case 0:
            _context3.n = 1;
  ...
  clearUserData: function () {
    var _clearUserData = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee4() {
      return _regenerator().w(function (_context4) {
        while (1) switch (_context4.n) {
          case 0:
            _context4.n = 1;
...
/* harmony export */ });
/* harmony import */ var _html_constructor_html_constructor_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../html-constructor/html-constructor.js */ "./static/assets/js/pages/html-constructor/html-constructor.js");
...
var TO_BUILD = [{
  ...
  tbl: _page_utilities_doc_element_references_js__WEBPACK_IMPORTED_MODULE_1__["default"].HOME_PAGE.SERVER_STATS_TBL,
...
function buildTable(tableElt, cols) {
  var id = tableElt.id;
  var constructor = new _html_constructor_html_constructor_js__WEBPACK_IMPORTED_MODULE_0__.TableConstructor(tableElt, id + "-head", id + "-body");
...
/* harmony import */ var _e7_filter_parsing_filter_syntax_parser_ts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../../../../e7/filter-parsing/filter-syntax-parser.ts */ "./static/assets/js/e7/filter-parsing/filter-syntax-parser.ts");
    ...
    return _regenerator().w(function (_context6) {
      while (1) switch (_context6.n) {
        ...
        case 15:
          ...
          _context6.n = 16;
          return _e7_filter_parsing_filter_syntax_parser_ts__WEBPACK_IMPORTED_MODULE_2__["default"].getFiltersFromCache(HM);
        case 16:
          filters = _context6.v;
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 5:
          ...
          _populate_content_js__WEBPACK_IMPORTED_MODULE_1__.Tables.populateServerStatsTable("server-stats-tbl", stats.serverStats);
...
/***/ "./static/assets/js/pages/html-constructor/html-constructor.js":
/*!*********************************************************************!*\
  !*** ./static/assets/js/pages/html-constructor/html-constructor.js ***!
  \*********************************************************************/
/***/ ((__unused_webpack___webpack_module__, __webpack_exports__, __webpack_require__) => {
...
function generateID() {
  ID_COUNTER += 1;
  return "id-".concat(ID_COUNTER);
}
var HTMLConstructor = /*#__PURE__*/function () {
  function HTMLConstructor(htmlElt) {
    _classCallCheck(this, HTMLConstructor);
    this.htmlElt = htmlElt;
    this.children = {};
    this.childArr = [];
  }
  return _createClass(HTMLConstructor, [{
    key: "id",
    get: function get() {
    ...
    value: function addClass() {
      var _this$htmlElt$classLi;
      (_this$htmlElt$classLi = this.htmlElt.classList).add.apply(_this$htmlElt$classLi, arguments);
    }
  }, {
    key: "removeClass",
    value: function removeClass() {
      var _this$htmlElt$classLi2;
      (_this$htmlElt$classLi2 = this.htmlElt.classList).remove.apply(_this$htmlElt$classLi2, arguments);
    }
  }, {
    key: "addAttributes",
    ...
    value: function appendChild(child) {
      if (child instanceof HTMLConstructor) {
        ...
        var wrapped = new HTMLConstructor(child);
    ...
    key: "insertInnerHTML",
    value: function insertInnerHTML(htmlStr) {
      this.htmlElt.innerHTML = htmlStr;
    }
  }, {
    key: "appendInnerHTML",
    value: function appendInnerHTML(htmlStr) {
      this.htmlElt.insertAdjacentHTML("beforeend", htmlStr);
    }
  }, {
    key: "constructChild",
    value: function constructChild(eltType) {
      var attributes = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      if (!attributes.id) attributes.id = generateID();
      var child = document.createElement(eltType);
      var constructor = new HTMLConstructor(child);
    ...
    key: "fromElt",
    value: function fromElt(elt) {
      return new HTMLConstructor(elt);
    }
  }]);
}();
var TableConstructor = /*#__PURE__*/function (_HTMLConstructor) {
  function TableConstructor(htmlElt, headID, bodyID) {
    var _this;
    _classCallCheck(this, TableConstructor);
    _this = _callSuper(this, TableConstructor, [htmlElt]);
    _this.constructChild("thead", {
      id: headID
    });
    _this.constructChild("tbody", {
      id: bodyID
    });
    _this.thead = _this.children[headID];
    _this.tbody = _this.children[bodyID];
    return _this;
  }
  _inherits(TableConstructor, _HTMLConstructor);
  return _createClass(TableConstructor, [{
    key: "addColumns",
    value: function addColumns(colNameArr) {
      var thead = this.thead;
      var tr = thead.constructChild("tr");
      colNameArr.forEach(function (colName) {
        var attributes = {
          scope: "col"
        };
    ...
    key: "createFromIDs",
    value: function createFromIDs(tableID, headID, bodyID) {
    ...
    var _getState = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          case 0:
            _context.n = 1;
            return _cache_manager_js__WEBPACK_IMPORTED_MODULE_0__["default"].get(_cache_manager_js__WEBPACK_IMPORTED_MODULE_0__["default"].Keys.INTER_PAGE_MANAGER);
          case 1:
            _t2 = _yield$ClientCache$ge = _context.v;
            _t = _t2 !== null;
            if (!_t) {
    ...
    var _setState = _asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee2(state) {
      return _regenerator().w(function (_context2) {
        while (1) switch (_context2.n) {
          case 0:
            _context2.n = 1;
            return _cache_manager_js__WEBPACK_IMPORTED_MODULE_0__["default"].cache(_cache_manager_js__WEBPACK_IMPORTED_MODULE_0__["default"].Keys.INTER_PAGE_MANAGER, state);
          case 1:
            return _context2.a(2);
        }
      }, _callee2);
      ...
      return _regenerator().w(function (_context4) {
        while (1) switch (_context4.n) {
          ...
          case 1:
            state = _context4.v;
            _context4.n = 2;
            return _cache_manager_js__WEBPACK_IMPORTED_MODULE_0__["default"]["delete"](_cache_manager_js__WEBPACK_IMPORTED_MODULE_0__["default"].Keys.INTER_PAGE_MANAGER);
          case 2:
...
var HomePageElements = /*#__PURE__*/function () {
  ...
  return _createClass(HomePageElements, [{
    ...
    key: "BATTLES_TABLE",
    get: function get() {
      return this._BATTLES_TABLE || (this._BATTLES_TABLE = _utils_ts__WEBPACK_IMPORTED_MODULE_0__.Safe.unwrapHtmlElt("BattlesTable"));
    }
  }, {
    key: "AUTO_ZOOM_FLAG",
    get: function get() {
    ...
    key: "SERVER_STATS_TBL",
    get: function get() {
      return this._SERVER_STATS_TBL || (this._SERVER_STATS_TBL = _utils_ts__WEBPACK_IMPORTED_MODULE_0__.Safe.unwrapHtmlElt("server-stats-tbl"));
    }
  }, {
...
/* harmony import */ var _orchestration_page_state_manager_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../orchestration/page-state-manager.js */ "./static/assets/js/pages/orchestration/page-state-manager.js");
/* harmony import */ var _e7_references_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../e7/references.ts */ "./static/assets/js/e7/references.ts");
/* harmony import */ var _e7_user_manager_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../e7/user-manager.js */ "./static/assets/js/e7/user-manager.js");
        ...
        return _regenerator().w(function (_context) {
          while (1) switch (_context.n) {
            ...
            case 2:
              ...
              _context.n = 3;
              return _e7_user_manager_js__WEBPACK_IMPORTED_MODULE_2__["default"].getUser();
            case 3:
              user = _context.v;
              if (user) {
                _context.n = 6;
...
/* harmony export */ });
/* harmony import */ var _e7_hero_manager_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../e7/hero-manager.js */ "./static/assets/js/e7/hero-manager.js");
/* harmony import */ var _e7_filter_parsing_filter_syntax_parser_ts__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../e7/filter-parsing/filter-syntax-parser.ts */ "./static/assets/js/e7/filter-parsing/filter-syntax-parser.ts");
/* harmony import */ var _orchestration_text_controller_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../orchestration/text-controller.js */ "./static/assets/js/pages/orchestration/text-controller.js");
function _regenerator() { /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/babel/babel/blob/main/packages/babel-helpers/LICENSE */ var e, t, r = "function" == typeof Symbol ? Symbol : {}, n = r.iterator || "@@iterator", o = r.toStringTag || "@@toStringTag"; function i(r, n, o, i) { var c = n && n.prototype instanceof Generator ? n : Generator, u = Object.create(c.prototype); return _regeneratorDefine2(u, "_invoke", function (r, n, o) { var i, c, u, f = 0, p = o || [], y = !1, G = { p: 0, n: 0, v: e, a: d, f: d.bind(e, 4), d: function d(t, r) { return i = t, c = 0, u = e, G.n = r, a; } }; function d(r, n) { for (c = r, u = n, t = 0; !y && f && !o && t < p.length; t++) { var o, i = p[t], d = G.p, l = i[2]; r > 3 ? (o = l === n) && (u = i[(c = i[4]) ? 5 : (c = 3, 3)], i[4] = i[5] = e) : i[0] <= d && ((o = r < 2 && d < i[1]) ? (c = 0, G.v = n, G.n = i[1]) : d < l && (o = r < 3 || i[0] > n || n > l) && (i[4] = r, i[5] = n, G.n = l, c = 0)); } if (o || r > 1) return a; throw y = !0, n; } return function (o, p, l) { if (f > 1) throw TypeError("Generator is already running"); for (y && 1 === p && d(p, l), c = p, u = l; (t = c < 2 ? e : u) || !y;) { i || (c ? c < 3 ? (c > 1 && (G.n = -1), d(c, u)) : G.n = u : G.v = u); try { if (f = 2, i) { if (c || (o = "next"), t = i[o]) { if (!(t = t.call(i, u))) throw TypeError("iterator result is not an object"); if (!t.done) return t; u = t.value, c < 2 && (c = 0); } else 1 === c && (t = i["return"]) && t.call(i), c < 2 && (u = TypeError("The iterator does not provide a '" + o + "' method"), c = 1); i = e; } else if ((t = (y = G.n < 0) ? u : r.call(n, G)) !== a) break; } catch (t) { i = e, c = 1, u = t; } finally { f = 1; } } return { value: t, done: y }; }; }(r, o, i), !0), u; } var a = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} t = Object.getPrototypeOf; var c = [][n] ? t(t([][n]())) : (_regeneratorDefine2(t = {}, n, function () { return this; }), t), u = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(c); function f(e) { return Object.setPrototypeOf ? Object.setPrototypeOf(e, GeneratorFunctionPrototype) : (e.__proto__ = GeneratorFunctionPrototype, _regeneratorDefine2(e, o, "GeneratorFunction")), e.prototype = Object.create(u), e; } return GeneratorFunction.prototype = GeneratorFunctionPrototype, _regeneratorDefine2(u, "constructor", GeneratorFunctionPrototype), _regeneratorDefine2(GeneratorFunctionPrototype, "constructor", GeneratorFunction), GeneratorFunction.displayName = "GeneratorFunction", _regeneratorDefine2(GeneratorFunctionPrototype, o, "GeneratorFunction"), _regeneratorDefine2(u), _regeneratorDefine2(u, o, "Generator"), _regeneratorDefine2(u, n, function () { return this; }), _regeneratorDefine2(u, "toString", function () { return "[object Generator]"; }), (_regenerator = function _regenerator() { return { w: i, m: f }; })(); }
function _regeneratorDefine2(e, r, n, t) { var i = Object.defineProperty; try { i({}, "", {}); } catch (e) { i = 0; } _regeneratorDefine2 = function _regeneratorDefine(e, r, n, t) { if (r) i ? i(e, r, { value: n, enumerable: !t, configurable: !t, writable: !t }) : e[r] = n;else { var o = function o(r, n) { _regeneratorDefine2(e, r, function (e) { return this._invoke(r, n, e); }); }; o("next", 0), o("throw", 1), o("return", 2); } }, _regeneratorDefine2(e, r, n, t); }
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          ...
          case 1:
            ...
            _context.p = 2;
            _context.n = 3;
            return _e7_filter_parsing_filter_syntax_parser_ts__WEBPACK_IMPORTED_MODULE_1__["default"].createAndParse(str, HM);
          case 3:
      ...
      return _regenerator().w(function (_context) {
        while (1) switch (_context.n) {
          ...
          case 1:
            user = _context.v;
            _context.n = 2;
            return _cache_manager_js__WEBPACK_IMPORTED_MODULE_2__["default"].get(_cache_manager_js__WEBPACK_IMPORTED_MODULE_2__["default"].Keys.AUTO_ZOOM_FLAG);
          case 2:
            autoZoom = _context.v;
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        ...
        case 2:
          user = _context.v;
          _context.n = 3;
          return _e7_user_manager_js__WEBPACK_IMPORTED_MODULE_7__["default"].clearUserData();
        case 3:
          _page_utilities_nav_bar_utils_js__WEBPACK_IMPORTED_MODULE_1__.NavBarUtils.writeUserInfo(null);
          _orchestration_text_controller_js__WEBPACK_IMPORTED_MODULE_2__.TextUtils.queueSelectDataMsgGreen("Cleared data of user ".concat(user.name, " (").concat(user.id, ")"));
          _context.n = 4;
...
/******/ })()
;
//# sourceMappingURL=home-page.13d0397f0a6c0d88effd.bundle.js.map