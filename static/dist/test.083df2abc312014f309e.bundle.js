...
document.addEventListener("DOMContentLoaded", /*#__PURE__*/_asyncToGenerator(/*#__PURE__*/_regenerator().m(function _callee() {
  var global_users, seasons, HM, artifacts, searcher, wolf, artiList, elbris;
  return _regenerator().w(function (_context) {
    while (1) switch (_context.n) {
      case 0:
        _context.n = 1;
        return _content_manager_js__WEBPACK_IMPORTED_MODULE_2__["default"].ClientCache.clearData();
      case 1:
        _context.n = 2;
...
/******/ })()
;
//# sourceMappingURL=test.083df2abc312014f309e.bundle.js.map