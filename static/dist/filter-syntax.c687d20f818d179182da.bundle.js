...
function cardBody(composeList, classes) {
    return {
        tag: "div",
...
function makeComposeList(lang) {
    const text = (block) => (0,_lang_builder__WEBPACK_IMPORTED_MODULE_0__.getText)(lang, block);
    function textStr(block) {
    ...
    const functionsBody = [
        ...
        cardBody([
            {
                tag: "p",
                textContent: textStr(Functions.clauseFunctionsTitle),
            },
            {
                tag: "p",
                classes: ["text-sm"],
                textContent: textStr(Functions.clauseFunctionsDescription),
            },
            filterSyntaxTable(SyntaxRulesTableRows({
                entries: [
            ...
            {
                tag: "p",
                textContent: textStr(Functions.directFunctionsTitle),
            },
            {
                tag: "p",
                classes: ["text-sm"],
                textContent: textStr(Functions.directFunctionsDescription),
            },
            filterSyntaxTable(SyntaxRulesTableRows({
                entries: [
            ...
            {
                tag: "p",
                textContent: textStr(Functions.globalFiltersTitle),
            },
            {
                tag: "p",
                classes: ["text-sm"],
                textContent: textStr(Functions.globalFiltersDescription),
            },
            filterSyntaxTable(SyntaxRulesTableRows({
                entries: [
...
/******/ })()
;
//# sourceMappingURL=filter-syntax.c687d20f818d179182da.bundle.js.map