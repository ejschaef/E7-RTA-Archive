...
/* harmony import */ var _filter_test_results__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./filter-test-results */ "./static/assets/js/tests/filter-test-results.ts");


function getSeqNumArray(battles) {
    return battles.map((b) => Number(b[_e7_references__WEBPACK_IMPORTED_MODULE_0__.COLUMNS_MAP.SEQ_NUM]));
}
...
const FilterTestDefinitions = {
    ...
    last100: {
        ...
        validationFn: (battles) => battles.length === 100 && battles[0][_e7_references__WEBPACK_IMPORTED_MODULE_0__.COLUMNS_MAP.DATE_TIME] === _filter_test_results__WEBPACK_IMPORTED_MODULE_1__.DT_RESULTS.last100,
    },
    last10: {
        name: "last10",
        filterStr: "last-N(10);",
        validationFn: (battles) => battles.length === 10 && battles[0][_e7_references__WEBPACK_IMPORTED_MODULE_0__.COLUMNS_MAP.DATE_TIME] === _filter_test_results__WEBPACK_IMPORTED_MODULE_1__.DT_RESULTS.last10,
    },
    ...
    commasInOr: {
        ...
        validationFn: (battles) => arraysEqual(getSeqNumArray(battles), _filter_test_results__WEBPACK_IMPORTED_MODULE_1__.SEQ_NUM_RESULTS.commasInOr),
    },
    setWithStrings: {
        name: "setWithStrings",
        filterStr: `p1.pick3 in {Zio, "Amid", "Lionheart Cermia"};`,
        validationFn: (battles) => arraysEqual(getSeqNumArray(battles), _filter_test_results__WEBPACK_IMPORTED_MODULE_1__.SEQ_NUM_RESULTS.setWithStrings),
    },
    parenthesesNot: {
        name: "parenthesesNot",
        filterStr: `NOT(is-first-turn = true);`,
        validationFn: (battles) => arraysEqual(getSeqNumArray(battles), _filter_test_results__WEBPACK_IMPORTED_MODULE_1__.SEQ_NUM_RESULTS.parenthesesNot),
    },
    nestedParentheses: {
        name: "nestedParentheses",
        filterStr: `AND(is-win = true, OR(p2.server = "Global", p2.server = "Korea"));`,
        validationFn: (battles) => arraysEqual(getSeqNumArray(battles), _filter_test_results__WEBPACK_IMPORTED_MODULE_1__.SEQ_NUM_RESULTS.nestedParentheses),
    },
    braceHeroSet: {
        name: "braceHeroSet",
        filterStr: `p1.pick1 in {"Abyssal Yufine", "New Moon luna"};`,
        validationFn: (battles) => arraysEqual(getSeqNumArray(battles), _filter_test_results__WEBPACK_IMPORTED_MODULE_1__.SEQ_NUM_RESULTS.braceHeroSet),
    },
    braceVictoryPoints: {
        name: "braceVictoryPoints",
        filterStr: `victory-points in {1646, 1668};`,
        validationFn: (battles) => arraysEqual(getSeqNumArray(battles), _filter_test_results__WEBPACK_IMPORTED_MODULE_1__.SEQ_NUM_RESULTS.braceVictoryPoints),
    },
    braceDateSet: {
        name: "braceDateSet",
    ...
    trailingSetComma: {
        ...
        filterStr: `p1.pick1 in { "Lone Wolf Peira", "Boss Arunka", };`,
        validationFn: (battles) => arraysEqual(getSeqNumArray(battles), _filter_test_results__WEBPACK_IMPORTED_MODULE_1__.SEQ_NUM_RESULTS.trailingSetComma),
    },
};
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   DT_RESULTS: () => (/* binding */ DT_RESULTS),
...
/* harmony import */ var _filter_test_definitions__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./filter-test-definitions */ "./static/assets/js/tests/filter-test-definitions.ts");
/* harmony import */ var _console_logging__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../console-logging */ "./static/assets/js/console-logging.ts");
/* harmony import */ var _e7_battle_manager__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../e7/battle-manager */ "./static/assets/js/e7/battle-manager.ts");




function genFilterBehaviorTest(filterTestPacket, battlesList, heroDicts) {
    return async () => {
        let passed = false;
        let filteredBattles = [];
        _console_logging__WEBPACK_IMPORTED_MODULE_2__.CONSOLE_LOGGER.bindCategory(_console_logging__WEBPACK_IMPORTED_MODULE_2__.LOG_CATEGORIES.TEST);
        try {
            const parser = await _e7_filter_parsing_filter_parser__WEBPACK_IMPORTED_MODULE_0__.FilterParser.fromFilterStr(filterTestPacket.filterStr, heroDicts);
            const filters = parser.getFilters();
            filteredBattles = await (0,_e7_battle_manager__WEBPACK_IMPORTED_MODULE_3__.applyFilters)(battlesList, filters);
        ...
        _console_logging__WEBPACK_IMPORTED_MODULE_2__.CONSOLE_LOGGER.unbindCategory();
        if (!passed) {
...
function genParseTest(filterTestPacket, battlesList, heroDicts) {
    return async () => {
        _console_logging__WEBPACK_IMPORTED_MODULE_2__.CONSOLE_LOGGER.bindCategory(_console_logging__WEBPACK_IMPORTED_MODULE_2__.LOG_CATEGORIES.TEST);
        try {
            const parser = await _e7_filter_parsing_filter_parser__WEBPACK_IMPORTED_MODULE_0__.FilterParser.fromFilterStr(filterTestPacket.filterStr, heroDicts);
            const filters = parser.getFilters();
            await (0,_e7_battle_manager__WEBPACK_IMPORTED_MODULE_3__.applyFilters)(battlesList, filters);
        }
        catch (e) {
...
async function runFilterTests(battlesList, heroDicts) {
    if (!battlesList || battlesList.length === 0) {
        console.error("No battles found for filter tests!");
        return;
    }
    const PARSE_TESTS = Object.values(_filter_test_definitions__WEBPACK_IMPORTED_MODULE_1__.FilterTestDefinitions).map((filterTestPacket) => genParseTest(filterTestPacket, battlesList, heroDicts));
    console.log("\n===================RUNNING PARSE TESTS===================\n");
    for (const test of PARSE_TESTS) {
        await test();
    }
    const genBehaviorTest = (filterTestPacket) => genFilterBehaviorTest(filterTestPacket, battlesList, heroDicts);
    const BEHAVIOR_TESTS = [
        genBehaviorTest(_filter_test_definitions__WEBPACK_IMPORTED_MODULE_1__.FilterTestDefinitions.last100),
        genBehaviorTest(_filter_test_definitions__WEBPACK_IMPORTED_MODULE_1__.FilterTestDefinitions.last10),
        genBehaviorTest(_filter_test_definitions__WEBPACK_IMPORTED_MODULE_1__.FilterTestDefinitions.nestedParentheses),
        genBehaviorTest(_filter_test_definitions__WEBPACK_IMPORTED_MODULE_1__.FilterTestDefinitions.braceHeroSet),
        genBehaviorTest(_filter_test_definitions__WEBPACK_IMPORTED_MODULE_1__.FilterTestDefinitions.braceDateSet),
        genBehaviorTest(_filter_test_definitions__WEBPACK_IMPORTED_MODULE_1__.FilterTestDefinitions.braceVictoryPoints),
        genBehaviorTest(_filter_test_definitions__WEBPACK_IMPORTED_MODULE_1__.FilterTestDefinitions.trailingSetComma),
        genBehaviorTest(_filter_test_definitions__WEBPACK_IMPORTED_MODULE_1__.FilterTestDefinitions.commasInOr),
        genBehaviorTest(_filter_test_definitions__WEBPACK_IMPORTED_MODULE_1__.FilterTestDefinitions.parenthesesNot),
        genBehaviorTest(_filter_test_definitions__WEBPACK_IMPORTED_MODULE_1__.FilterTestDefinitions.setWithStrings),
    ];
...
/* harmony export */ });
/* harmony import */ var _content_manager__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../content-manager */ "./static/assets/js/content-manager.ts");
/* harmony import */ var _filter_tests__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./filter-tests */ "./static/assets/js/tests/filter-tests.ts");
/* harmony import */ var _stats_tests__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./stats-tests */ "./static/assets/js/tests/stats-tests.ts");
...
async function runTests() {
    ...
    await (0,_filter_tests__WEBPACK_IMPORTED_MODULE_1__.runFilterTests)(battlesList, heroDicts);
    await (0,_stats_tests__WEBPACK_IMPORTED_MODULE_2__.runStatsTests)(battlesList, heroDicts);
}


/***/ }),

/***/ "./static/assets/js/tests/stats-test-definitions.ts":
/*!**********************************************************!*\
  !*** ./static/assets/js/tests/stats-test-definitions.ts ***!
  \**********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _e7_references__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../e7/references */ "./static/assets/js/e7/references.ts");
/* harmony import */ var _e7_stats_builder__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../e7/stats-builder */ "./static/assets/js/e7/stats-builder.ts");


const genStats = _e7_stats_builder__WEBPACK_IMPORTED_MODULE_1__["default"].computeGenericStats;
...
const STATS_TESTS = [
    ...
    },
    {
        ...
        eval: (battles, filteredBattles) => {
            const filterResult = compWinrate(filteredBattles);
            const globalBattles = battles.filter((b) => b[_e7_references__WEBPACK_IMPORTED_MODULE_0__.COLUMNS_MAP.P2_SERVER] === _e7_references__WEBPACK_IMPORTED_MODULE_0__.WORLD_CODE_TO_CLEAN_STR[_e7_references__WEBPACK_IMPORTED_MODULE_0__.WORLD_CODE_ENUM.GLOBAL]);
    ...
    },
    {
        ...
        eval: (battles, filteredBattles) => {
            ...
            const bossArunkaBattles = battles.filter((b) => b[_e7_references__WEBPACK_IMPORTED_MODULE_0__.COLUMNS_MAP.P1_PICKS].includes("Boss Arunka"));
...
/***/ "./static/assets/js/tests/stats-tests.ts":
/*!***********************************************!*\
  !*** ./static/assets/js/tests/stats-tests.ts ***!
  \***********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _stats_test_definitions__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./stats-test-definitions */ "./static/assets/js/tests/stats-test-definitions.ts");
/* harmony import */ var _console_logging__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../console-logging */ "./static/assets/js/console-logging.ts");




async function genStatsTest(test, battles, heroDicts) {
    _console_logging__WEBPACK_IMPORTED_MODULE_3__.CONSOLE_LOGGER.bindCategory(_console_logging__WEBPACK_IMPORTED_MODULE_3__.LOG_CATEGORIES.TEST);
    try {
    ...
    _console_logging__WEBPACK_IMPORTED_MODULE_3__.CONSOLE_LOGGER.unbindCategory();
    console.log(`Test: "${test.name}" Passed`);
}
async function runStatsTests(battles, heroDicts) {
    console.log("\n===================RUNNING STATS TESTS===================\n");
    const battlesList = Object.values(battles);
    for (const test of _stats_test_definitions__WEBPACK_IMPORTED_MODULE_2__.STATS_TESTS) {
...
/******/ })()
;
//# sourceMappingURL=test.bc1611e616603101ae07.bundle.js.map