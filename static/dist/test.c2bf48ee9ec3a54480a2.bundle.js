...
class Logger {
    ...
    initialize() {
        console.log = function (...args) {
            this.log.apply(CONSOLE_LOGGER, args);
        };
    }
    ...
    bindCapture(key) {
        this.captures[key] = this.captures[key] || [];
        this.captureKey = key;
    }
    unbindCapture() {
...
/* harmony import */ var _tests_run_tests_ts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../tests/run-tests.ts */ "./static/assets/js/tests/run-tests.ts");
/* harmony import */ var _html_constructor_html_constructor_ts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./html-constructor/html-constructor.ts */ "./static/assets/js/pages/html-constructor/html-constructor.ts");
/* harmony import */ var _page_utilities_nav_bar_utils_ts__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./page-utilities/nav-bar-utils.ts */ "./static/assets/js/pages/page-utilities/nav-bar-utils.ts");
function _regenerator() { /*! regenerator-runtime -- Copyright (c) 2014-present, Facebook, Inc. -- license (MIT): https://github.com/babel/babel/blob/main/packages/babel-helpers/LICENSE */ var e, t, r = "function" == typeof Symbol ? Symbol : {}, n = r.iterator || "@@iterator", o = r.toStringTag || "@@toStringTag"; function i(r, n, o, i) { var c = n && n.prototype instanceof Generator ? n : Generator, u = Object.create(c.prototype); return _regeneratorDefine2(u, "_invoke", function (r, n, o) { var i, c, u, f = 0, p = o || [], y = !1, G = { p: 0, n: 0, v: e, a: d, f: d.bind(e, 4), d: function d(t, r) { return i = t, c = 0, u = e, G.n = r, a; } }; function d(r, n) { for (c = r, u = n, t = 0; !y && f && !o && t < p.length; t++) { var o, i = p[t], d = G.p, l = i[2]; r > 3 ? (o = l === n) && (u = i[(c = i[4]) ? 5 : (c = 3, 3)], i[4] = i[5] = e) : i[0] <= d && ((o = r < 2 && d < i[1]) ? (c = 0, G.v = n, G.n = i[1]) : d < l && (o = r < 3 || i[0] > n || n > l) && (i[4] = r, i[5] = n, G.n = l, c = 0)); } if (o || r > 1) return a; throw y = !0, n; } return function (o, p, l) { if (f > 1) throw TypeError("Generator is already running"); for (y && 1 === p && d(p, l), c = p, u = l; (t = c < 2 ? e : u) || !y;) { i || (c ? c < 3 ? (c > 1 && (G.n = -1), d(c, u)) : G.n = u : G.v = u); try { if (f = 2, i) { if (c || (o = "next"), t = i[o]) { if (!(t = t.call(i, u))) throw TypeError("iterator result is not an object"); if (!t.done) return t; u = t.value, c < 2 && (c = 0); } else 1 === c && (t = i["return"]) && t.call(i), c < 2 && (u = TypeError("The iterator does not provide a '" + o + "' method"), c = 1); i = e; } else if ((t = (y = G.n < 0) ? u : r.call(n, G)) !== a) break; } catch (t) { i = e, c = 1, u = t; } finally { f = 1; } } return { value: t, done: y }; }; }(r, o, i), !0), u; } var a = {}; function Generator() {} function GeneratorFunction() {} function GeneratorFunctionPrototype() {} t = Object.getPrototypeOf; var c = [][n] ? t(t([][n]())) : (_regeneratorDefine2(t = {}, n, function () { return this; }), t), u = GeneratorFunctionPrototype.prototype = Generator.prototype = Object.create(c); function f(e) { return Object.setPrototypeOf ? Object.setPrototypeOf(e, GeneratorFunctionPrototype) : (e.__proto__ = GeneratorFunctionPrototype, _regeneratorDefine2(e, o, "GeneratorFunction")), e.prototype = Object.create(u), e; } return GeneratorFunction.prototype = GeneratorFunctionPrototype, _regeneratorDefine2(u, "constructor", GeneratorFunctionPrototype), _regeneratorDefine2(GeneratorFunctionPrototype, "constructor", GeneratorFunction), GeneratorFunction.displayName = "GeneratorFunction", _regeneratorDefine2(GeneratorFunctionPrototype, o, "GeneratorFunction"), _regeneratorDefine2(u), _regeneratorDefine2(u, o, "Generator"), _regeneratorDefine2(u, n, function () { return this; }), _regeneratorDefine2(u, "toString", function () { return "[object Generator]"; }), (_regenerator = function _regenerator() { return { w: i, m: f }; })(); }
function _regeneratorDefine2(e, r, n, t) { var i = Object.defineProperty; try { i({}, "", {}); } catch (e) { i = 0; } _regeneratorDefine2 = function _regeneratorDefine(e, r, n, t) { if (r) i ? i(e, r, { value: n, enumerable: !t, configurable: !t, writable: !t }) : e[r] = n;else { var o = function o(r, n) { _regeneratorDefine2(e, r, function (e) { return this._invoke(r, n, e); }); }; o("next", 0), o("throw", 1), o("return", 2); } }, _regeneratorDefine2(e, r, n, t); }
function asyncGeneratorStep(n, t, e, r, o, a, c) { try { var i = n[a](c), u = i.value; } catch (n) { return void e(n); } i.done ? t(u) : Promise.resolve(u).then(r, o); }
function _asyncToGenerator(n) { return function () { var t = this, e = arguments; return new Promise(function (r, o) { var a = n.apply(t, e); function _next(n) { asyncGeneratorStep(a, r, o, _next, _throw, "next", n); } function _throw(n) { asyncGeneratorStep(a, r, o, _next, _throw, "throw", n); } _next(void 0); }); }; }
    ...
    return _regenerator().w(function (_context) {
      while (1) switch (_context.n) {
        case 0:
          ...
          _context.n = 1;
          return _content_manager_ts__WEBPACK_IMPORTED_MODULE_0__.ContentManager.ClientCache.clearReferenceData();
        case 1:
          _context.n = 2;
          return _page_utilities_nav_bar_utils_ts__WEBPACK_IMPORTED_MODULE_4__.NavBarUtils.initialize();
        case 2:
          _context.n = 3;
          return (0,_tests_run_tests_ts__WEBPACK_IMPORTED_MODULE_2__.runTests)();
        case 3:
          return _context.a(2);
      }
    }, _callee);
...
async function performTest(test, battles, heroDicts, isParseTest) {
    try {
...
async function runEvalTest(test, battles, heroDicts) {
    ...
    if (testResult) {
        ...
        console.log(_console_logging__WEBPACK_IMPORTED_MODULE_4__.CONSOLE_LOGGER.captures[test.name]);
        bar();
    }
}
...
async function runTests() {
    ...
    console.log("Captured Logs:", _console_logging__WEBPACK_IMPORTED_MODULE_4__.CONSOLE_LOGGER.captures);
}
...
function getCR(battle, heroName) {
    const crEntry = battle[_e7_references__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.CR_BAR].find((entry) => entry[0] === heroName);
    return crEntry ? crEntry[1] : null;
}
function computeAvgCR(battles, heroName) {
    let totalCR = 0;
    ...
    return _e7_stats_builder__WEBPACK_IMPORTED_MODULE_2__["default"].divideToPercentString(totalCR / 100, battles.length);
}
function computeFirstTurnRate(battles, heroName) {
    const firstTurns = battles.filter((b) => b[_e7_references__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.FIRST_TURN_HERO] === heroName).length;
    return _e7_stats_builder__WEBPACK_IMPORTED_MODULE_2__["default"].divideToPercentString(firstTurns, battles.length);
}
...
const FilterTests = [
    ...
    // Base Filters - season
    {
        ...
        eval: (battles, filteredBattles) => {
            const season17f = filterColByFn(battles, _e7_references__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.SEASON_CODE, (v) => v.includes("17f"));
    ...
    },
    {
        ...
        eval: (battles, filteredBattles) => {
            const currentSeason = filterColByFn(battles, _e7_references__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.SEASON_CODE, (v) => v === "pvp_rta_ss17");
    ...
    },
    {
        ...
        eval: (battles, filteredBattles) => {
            const currentSeason = filterColByFn(battles, _e7_references__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.SEASON_CODE, (v) => v === "pvp_rta_ss17" || v === "pvp_rta_ss17f");
            return setsEqual(getSeqNumSet(currentSeason), getSeqNumSet(filteredBattles));
        }
    },
    // Base Filters - Range
...
const STATS_TESTS = [
    ...
    },
    {
        ...
        eval: (battles, filteredBattles) => {
            const champSubset = filterColByVals(battles, _e7_references__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.P2_LEAGUE, [_e7_references__WEBPACK_IMPORTED_MODULE_1__.LEAGUE_MAP.champion]);
            const champSubsetSecondPick = filterColByFn(champSubset, _e7_references__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.FIRST_PICK, (isFirstPick) => !isFirstPick);
            const filterResult = _e7_stats_builder__WEBPACK_IMPORTED_MODULE_2__["default"].divideToPercentString(filteredBattles.length, champSubsetSecondPick.length);
            const stats = _e7_stats_builder__WEBPACK_IMPORTED_MODULE_2__["default"].getPerformanceStats(battles);
            const champStats = stats.find((statsBundle) => statsBundle.label.toLowerCase().includes("champion"));
            if (!champStats)
                return [filterResult, "Champ Stats not found"];
    ...
    },
    {
        ...
        eval: (battles, filteredBattles, heroDicts) => {
            const filterResult = compPlusMinus(filteredBattles);
            const prebanStats = _e7_stats_builder__WEBPACK_IMPORTED_MODULE_2__["default"].getPrebanStats(battles, heroDicts);
    ...
    },
    {
        ...
        eval(battles, filteredBattles) {
            ...
            const filterResult = _e7_stats_builder__WEBPACK_IMPORTED_MODULE_2__["default"].divideToPercentString(filteredBattles.length, newMoonLuna.length);
            const stats = _e7_stats_builder__WEBPACK_IMPORTED_MODULE_2__["default"].queryStats(newMoonLuna, battles.length, "New Moon Luna");
    ...
    },
    {
        ...
        eval(battles, filteredBattles) {
            ...
            const crStats = _e7_stats_builder__WEBPACK_IMPORTED_MODULE_2__["default"].computeCRStats(loneWolfPeira, "Lone Wolf Peira");
    ...
    },
    {
        ...
        eval(battles, filteredBattles) {
            ...
            const crStats = _e7_stats_builder__WEBPACK_IMPORTED_MODULE_2__["default"].computeCRStats(zio, "Zio");
            const scriptResult = crStats.avgCR + crStats.firstTurnRate;
            return [filterResult, scriptResult];
        }
    },
    ...
    },
    {
        ...
        filterStr: `is-win = true;`,
        eval(battles, filteredBattles) {
            const generalStats = _e7_stats_builder__WEBPACK_IMPORTED_MODULE_2__["default"].getGeneralStats(battles);
    ...
    },
    {
        ...
        eval(battles, filteredBattles) {
            ...
            const secondPickGames = filterColByFn(battles, _e7_references__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.FIRST_PICK, (v) => !v);
            const filterResult = _e7_stats_builder__WEBPACK_IMPORTED_MODULE_2__["default"].divideToPercentString(filteredBattles.length, secondPickGames.length);
            return [filterResult, scriptResult];
        }
    },
    {
        ...
        eval(battles) {
            ...
            const filterResult = Math.max(...battles.map((b) => b[_e7_references__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.TURNS]));
            return [filterResult, scriptResult];
        }
    },
    {
        ...
        eval(battles) {
            ...
            const filterResult = _e7_stats_builder__WEBPACK_IMPORTED_MODULE_2__["default"].secondsToTimeStr(Math.max(...battles.map((b) => b[_e7_references__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.SECONDS])));
            return [filterResult, scriptResult];
        }
    },
    {
        ...
        eval(battles) {
            ...
            const totalPoints = battles.reduce((acc, b) => acc + (b[_e7_references__WEBPACK_IMPORTED_MODULE_1__.COLUMNS_MAP.POINT_GAIN] || 0), 0);
            const filterResult = _e7_stats_builder__WEBPACK_IMPORTED_MODULE_2__["default"].divideToString(totalPoints, battles.length);
            return [filterResult, scriptResult];
        }
    }
];
...
/******/ })()
;
//# sourceMappingURL=test.c2bf48ee9ec3a54480a2.bundle.js.map